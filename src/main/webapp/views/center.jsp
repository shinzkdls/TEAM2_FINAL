        ...
        <div class="row">
          ...
          <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="text-center">
                  <a target="_blank" rel="nofollow" href="http://127.0.0.1:80/cookingclass/detail?classpin=${classdetail.classpin}">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                         src="/uimg/${classdetail.thumbnailimg}" alt="...">
                  </a>
                </div>
                <p>${classdetail.classdesc}</p>
                <a target="_blank" rel="nofollow" href="http://127.0.0.1:80/cookingclass/detail?classpin=${classdetail.classpin}">${classdetail.classtitle}</a>
              </div>
            </div>
